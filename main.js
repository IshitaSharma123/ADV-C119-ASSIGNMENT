...
function check_sketch() {
    ...
    if(timer_counter > 400) {
        document.getElementById("Your_Sketch").innerHTML = "Your Sketch is : ";
        document.getElementById("Confidence").innerHTML = "Confidence is  : ";
...
function setup() {
    ...
    canvas.center();
    background("white");
    canvas.mouseRealeased(ClassiflyCanvas);
}
